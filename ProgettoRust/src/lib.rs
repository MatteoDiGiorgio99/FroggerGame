...
impl BounceGui {
    pub fn new() -> BounceGui {
        let game = frogger::FroggerGame::new(pt2d::pt(640, 448), 2, 5);
        BounceGui{game}
    }
    pub fn setup(&self) {
    ...
    pub fn tick(&mut self) {
        g2d::clear_canvas();
        g2d::draw_image_clip("background.png".to_string(), pt2d::pt(0, 0), pt2d::pt(0, 16), pt2d::pt(640, 448));
        ...
        g2d::set_color(157, 213, 47); //colore live e time
